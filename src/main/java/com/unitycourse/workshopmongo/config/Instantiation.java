package com.unitycourse.workshopmongo.config;
...
import com.unitycourse.workshopmongo.dto.AuthorDTO;
import com.unitycourse.workshopmongo.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Post post2 = new Post(null, sdf.parse("23/03/2018"), "Bom dia", "Acordei feliz hojeS",new AuthorDTO(maria));
